...
export default class AppCardCategory extends LitElement {
  static get styles() {
    return css`
    .mainCard {
  display: flex;
...
<div class="card">
  ...
  <div class="card-body">
    ...
    <div class="card-body">
      ...
      <span><img src="https://cdn-icons.flaticon.com/png/128/2956/premium/2956792.png?token=exp=1636353688~hmac=6af4a9f541cbb75362f01fd0c2a0c17c"></span>
...
customElements.define("app-cardcategory", AppCardCategory);
